_base_ = [
    ...
    '../_base_/datasets/fishtrack_detection.py',
    '../_base_/schedules/schedule_1x.py', '../_base_/default_runtime.py'
]

# _base_.optim_wrapper.type = 'AmpOptimWrapper'
_base_.model.roi_head.bbox_head.num_classes=1
_base_.model.init_cfg=dict(type='Pretrained', checkpoint='models/faster-rcnn_x101-32x8d_fpn_ms-3x_coco'),
